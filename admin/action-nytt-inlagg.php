...
/*
$sql = "CREATE TABLE BloggInlaggPlus (inlaggId INT AUTO_INCREMENT PRIMARY KEY, titel VARCHAR(255), brodtext VARCHAR(10000))";
...
if (!empty($TITEL)) {
  ...
  if ($db_conn->query($sql) === TRUE) {
    echo "<div class='success-notice'>Ditt inlägg har skapats!</div>";
} else {
    echo "Fel: " . $sql . "<br>" . $db_conn->error;
} 
}   else {
    echo "<div class='error-notice'>Kan inte skapa tomt inlägg!</div>";
  }
