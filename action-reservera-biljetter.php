...
while ($row = mysqli_fetch_object($result)) {
  ...
  if ($db_conn->query($sql) === TRUE) {
    echo "<div class='success-notice less-margin'>Dina biljetter har reserverats!</div>";
} else {
    echo "Fel: " . $sql . "<br>" . $db_conn->error;
} 
}   else {
    echo "<div class='error-notice less-margin'>Ett eller flera fält är tomma!</div>";
  }

    } else {
      echo "<div class='error-notice less-margin'>Nöjet har inte tillräckligt många lediga platser!</div>";
    }
